...
namespace NanoVector
{
    ...
    {
        public static unsafe float Compare(ReadOnlyMultiVector x, ReadOnlyMultiVector y)
        {
        ...
        public static unsafe float DotProduct(ReadOnlyMultiVector x, ReadOnlyMultiVector y)
        {
